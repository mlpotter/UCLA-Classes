...
def sgd_momentum(w, dw, config=None):
    ...
    # ================================================================ #
    #v = config.get("momentum")*v + (1-config.get("momentum"))*dw
...
def adam(w, dw, config=None):
    ...
    a = config['beta2']*config['a'] + (1-config['beta2'])*(dw**2)
    
    config['v'] = v 
    config['a'] = a 
    config['t'] = config['t'] + 1
    
    a_ = a * 1/(1-config['beta2']**config["t"])
    v_ = v * 1/(1-config['beta1']**config["t"])
